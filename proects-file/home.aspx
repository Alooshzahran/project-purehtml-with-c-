            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                    <ul id="navUl" class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="navtext nav-link active" aria-current="page" href="aboutus.aspx">About Us</a>
                        </li>
                        <li class="nav-item">
                            <a class="navtext nav-link active" aria-current="page" href="contactPage.aspx">Contact Us</a>
                        </li>
                        <li class="nav-item">
                            <a class="navtext nav-link active" aria-current="page" href="register.aspx">Register</a>
                        </li>
                        <li class="nav-item">
                            <a class="navtext nav-link active" aria-current="page" href="signin.aspx">Sign In</a>
                        </li>
                        <li class="nav-item">
                            <a class="navtext nav-link active" aria-current="page" href="cart.aspx"><i class="fa-sharp fa-solid fa-cart-shopping"></i></a>
                        </li>
