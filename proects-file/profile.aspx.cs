...
namespace project_5
{
    ...
    {
        SqlConnection con = new SqlConnection("data source = DESKTOP-4AD4H97\\SQLEXPRESS; database =project5 ; integrated security=SSPI");
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conup = new SqlConnection("Data Source=DESKTOP-4AD4H97\\SQLEXPRESS;Database=project5;Integrated Security=True;");
